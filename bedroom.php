    ...
    <div class="more-info about-info">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="service-item" onclick="zoomIn(this)">
                        <img src="./assets/product-images/bedroom/bedroom7.jpg" alt="">
                    </div>
                    <br>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-item" onclick="zoomIn(this)">
                        <img src="./assets/product-images/bedroom/bedroom14.jpg" alt="">
                    </div>
                    <br>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-item" onclick="zoomIn(this)">
                        <img src="./assets/product-images/bedroom/bedroom15.jpg" alt="">
                    </div>
                    <br>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-item" onclick="zoomIn(this)">
                        <img src="./assets/product-images/bedroom/bedroom16.jpg" alt="">
                    </div>
                    <br>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-item" onclick="zoomIn(this)">
                        <img src="./assets/product-images/bedroom/bedroom17.jpg" alt="">
                    </div>
                    <br>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-item" onclick="zoomIn(this)">
                        <img src="./assets/product-images/bedroom/bedroom18.jpg" alt="">
                    </div>
                    <br>
                </div>
                ...
                <div class="col-md-4">
                    <div class="service-item" onclick="zoomIn(this)">
                        <img src="./assets/product-images/bedroom/bedroom19.jpg" alt="">
                    </div>
                    <br>
                </div>
